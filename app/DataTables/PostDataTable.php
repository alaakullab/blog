...
class PostDataTable extends DataTable {
	...
	public function dataTable(DataTables $dataTables, $query) {
		return datatables($query)
			->addColumn('tag_id', 'admin.post.buttons.tag')
			->addColumn('user_id', 'admin.post.buttons.user')
			->addColumn('status', 'admin.post.buttons.status')
			->addColumn('actions', 'admin.post.buttons.actions')
			...
			$html = $this->builder()
				...
				->parameters([
					...
					'buttons' => [
						...
						[
							'text' => '<i class="fa fa-trash"></i> ' . trans('admin.Delete_completely'),
							'className' => 'btn red btn-outline deleteBtn2',
						],
						[
							'text' => '<i class="fa  fa-reply"></i> ' . trans('admin.recovery'),
							'className' => 'btn green btn-outline recovery',
						],
						[
