...
{!! Form::open(['url'=>url('/E-commerce/account/Change_password') ,'method'=>'post']) !!}                            <div class="row">
...
<button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> {{ trans('admin.Save_new_password') }}</button>
</div>
</form>
