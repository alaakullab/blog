            ...
            <div class="col-md-6">
                <div class="box">
                    ...
                    <div class="form-group {{$errors->get('username') ? 'has-error' : '' }}">
                        ...
                        <input class="form-control" id="name" name="username" value="{{old('username')}}" type="text" pattern="[A-Za-z]+" title="{{awTtrans('A letter from A to Z','en')}}" required=""  >
...
{{ $errors->first('email') }} </span>
                    ...
                    <div class="form-group {{$errors->get('password') ? 'has-error' : '' }}">
                        ...
                        <input class="form-control" id="password" name="password" type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"  required=""  title="{{awTtrans('Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters','en')}}">
                        ...
                        <input class="form-control" id="password_confirmation" name="password_confirmation" type="password"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"  required="" >
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary"><i class="fa fa-user-md"></i> {{trans('admin.register')}}</button>
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="box">
                    ...
                    {!! Form::open(['url'=>url('/E-commerce/login_ecommerce'),'method'=>'post']) !!}
