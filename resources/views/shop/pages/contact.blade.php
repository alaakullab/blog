...
_________________________________________________________ -->
            <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">@awt('Pages','en')</h3>
                </div>
                ...
                <div class="panel-body">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li>
                            <a href="{{url('E-commerce')}}">{{trans('admin.store')}}</a>
                        </li>
...
{{ $errors->first('message') }} </span>
                    ...
                    <div class="col-sm-12 text-center">
                        <button type="submit" class="btn btn-primary"><i class="fa fa-envelope-o"></i> {{trans('admin.Send_message')}}</button>
