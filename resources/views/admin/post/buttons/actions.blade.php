				...
				<div class="btn-group">
						...
						<ul class="dropdown-menu pull-right">
							@if(request()->has('softdelete'))
								<li>
										<a href="{{ aurl('/post/'.$id.'/recovery')}}"><i class="fa  fa-reply"></i> {{trans('admin.recovery')}}</a>
								</li>
								@else
								<li>
										<a href="{{ aurl('/post/'.$id.'/edit')}}"><i class="fa fa-pencil-square-o"></i> {{trans('admin.edit')}}</a>
								</li>
								<li class="divider"> </li>
								<li>
										<a href="{{ aurl('/post/'.$id)}}"><i class="fa fa-eye"></i> {{trans('admin.show')}}</a>
								</li>
								<li>
