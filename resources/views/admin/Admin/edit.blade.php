...
<div class="col-md-9">
<input type="password" class="form-control" name="password" id="password_strength" value="{{ $admin->password}}" placeholder="{{trans('admin.password')}}">
{{--
{!! Form::text('password', $admin->password ,['class'=>'form-control','placeholder'=>trans('admin.password')]) !!} --}}
</div>
</div>
