		...
		<div class="actions">
				<div class="btn-group">
						...
						<ul class="dropdown-menu pull-right">
								...
								<li>
										<a href="{{ aurl('/tag/'.$id.'/recovery')}}"><i class="fa  fa-reply"></i> {{trans('admin.recovery')}}</a>
								</li>
								@else
								<li>
										<a href="{{ aurl('/tag/'.$id.'/edit')}}"><i class="fa fa-pencil-square-o"></i> {{trans('admin.edit')}}</a>
								</li>
								<li class="divider"> </li>
								<li>
										<a href="{{ aurl('/tag/'.$id)}}"><i class="fa fa-eye"></i> {{trans('admin.show')}}</a>
								</li>
								@endif
								<li>
				...
				<div class="modal-dialog">
						<div class="modal-content">
								...
								<div class="modal-footer">
										{!! Form::open([
										'method' => 'DELETE',
										'route' => ['tag.destroy', $id]
										]) !!}
										{!! Form::submit(trans('admin.approval'), ['name'=>'delete','class' => 'btn btn-danger']) !!}
