...
<script src="{{url("design\admin_panel\jstree\jstree.js")}}"></script>
<script src="{{url("design\admin_panel\jstree\jstree.wholerow.js")}}"></script>
<script src="{{url("design\admin_panel\jstree\jstree.checkbox.js")}}"></script>
